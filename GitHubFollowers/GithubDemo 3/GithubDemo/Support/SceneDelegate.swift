...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func createSearchNC() -> UINavigationController{
        ...
        let navigaionController = UINavigationController(rootViewController: searchVC)
    ...
    func createFavoriteNC() -> UINavigationController{
        ...
        let navigationController = UINavigationController(rootViewController: favoriteListVc)
    ...
    func sceneDidBecomeActive(_ scene: UIScene) {
        ...
        if !NetworkStatus.shared.isOn{
            let alertVC = MTAlertVC(title: "Network error", message: "Please check internet connection", buttonTitle: "Ok")
            return
        }else{
            print(" internet YES")
        }
